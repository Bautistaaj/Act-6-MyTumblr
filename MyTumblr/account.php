<?php
    ...
    if(isset($_SESSION['ses_username'])===false){
        header("Location: indexs.php?logfirst");
    }else if(isset($_REQUEST['logout'])===true){
        session_destroy();
        header("Location: indexs.php?logout");
    }
?>
        ...
        <div class="bg-white shadow rounded overflow-hidden">
            <div class="px-4 pt-0 pb-4 cover">
                <div class="media align-items-end profile-head">
                    <div class="profile mr-3"><img src="images/aj.jpg" alt="..." width="150" class="rounded mb-2 img-thumbnail">
                    ...
                    <div class="media-body mb-5 text-white">
                        ...
                        <p class="small mb-4"> <i class="fas fa-map-marker-alt mr-2"></i><?php  echo $_SESSION['ses_adress']?>
                         </p>
                    </div>
                </div>
            </div>
            ...
            <div class="px-4 py-3">
                ...
                <div class="p-4 rounded shadow-sm bg-light">
                    ...
                    <p class="font-italic mb-0">Singing</p>
